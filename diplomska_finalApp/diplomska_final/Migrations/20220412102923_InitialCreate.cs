        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    totalMintues = table.Column<int>(type: "int", nullable: false),
                    totalSteps = table.Column<int>(type: "int", nullable: false),
                    ingredientsTypes = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Text_Comment = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RecipesId = table.Column<int>(type: "int", nullable: false),
                    DateCreated = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecipesComments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RecipesComments_Recipes_RecipesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecipesComments_RecipesId",
